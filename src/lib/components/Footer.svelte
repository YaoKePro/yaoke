<footer class="border-t border-border bg-primary mt-auto py-12 px-6">
  <div class="max-w-6xl mx-auto">
    <div class="flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0">
      <!-- Left side - Name/Brand -->
      <div>
        <h3 class="font-serif text-xl font-semibold text-primary mb-2">
          Yao Ke
        </h3>
      ...
      <div class="flex flex-col space-y-3">
        <h4 class="text-sm font-semibold text-primary mb-2">Navigation</h4>
      ...
      <div>
        ...
        <div class="flex space-x-4">
          <a href="https://github.com/BlueprintLabIO/"
             target="_blank"
          ...
          <a href="https://au.linkedin.com/in/yao-ke-505085247"
             target="_blank"
             rel="noopener noreferrer"
             class="social-link"
             aria-label="LinkedIn">
